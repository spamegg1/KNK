...
// The first sum is 6 + 1 + 8 + 2 + 0 + 0 = 17, and the second sum is
// 8 + 9 + 4 + 4 + 6 + 0 = 31. Multiplying the first sum by 3 and
// adding the second yields 82. Subtracting 1 gives 81.
...
// Your job is to modify the upc.c program of Section 4.1 so that
// it calculates the check digit for an EAN. The user will
