...
// GSI prefix) is currently either 978 or 979. The group identifier specifies
...
int main(void)
{
    int prefix, group, publisher, item, check_digit; // not pointers

    printf("Enter ISBN: ");
    scanf("%d-%d-%d-%d-%d", &prefix, &group, &publisher, &item, &check_digit); // pointers
